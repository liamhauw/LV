...
class HelloTriangleApplication {
 ...
 private:
  ...
  void SetEnvVariables() {
    ...
    setenv("VK_LAYER_PATH", LIAM_XSTR(LIAM_VK_LAYER_PATH), 1);
    setenv("VK_ICD_FILENAMES", LIAM_XSTR(LIAM_VK_ICD_FILENAMES), 1);
#elif defined(_WIN32)
    SetEnvironmentVariableA("VK_LAYER_PATH", LIAM_XSTR(LIAM_VK_LAYER_PATH));
#endif
  }
